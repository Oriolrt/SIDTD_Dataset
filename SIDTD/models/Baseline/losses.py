...
def loss_select(args, N_CLASSES):
    """
    ...
    Returns:
        criterion (torch.nn.Module inherited)
    """
    loss_params  = {'anneal':args.sigmoid_temperature, 'batch_size':args.batch_size, "num_id":N_CLASSES, 'feat_dims': args.embed_dim}
