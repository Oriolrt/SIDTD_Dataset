...
CUDA_VISIBLE_DEVICES=1 python test_fsl.py --model resnet50 --k_shot 5 --name few_shot_setting_trained_github --dataset clip_cropped_MIDV2020 --repetition 10 --pretrained_model