...
import SIDTD.models.fsl_models.models.configs as configs
...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, in_channels=3):
        ...
        #self.position_embeddings = nn.Parameter(torch.zeros(1, 197, config.hidden_size))
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=299, num_classes=21843, smoothing_value=0, zero_head=False):
