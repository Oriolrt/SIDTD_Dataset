...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, embed_dim=512, num_classes=21843, smoothing_value=0, zero_head=False):
        ...
        self.part_head = Linear(config.hidden_size, embed_dim)
