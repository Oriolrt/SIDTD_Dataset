...
from utils.data_tools import TaskSampler, TaskSamplerCoAARC, EasySetRandom, EasySetCoAARCRandom
...
def main(args):
    ...
    for nb_rep in range(args.repetition):
            ...
            for episode_index, (support_images, support_labels, query_images, query_labels, _) in tqdm_train:
                ...
                if episode_index % val_episode == 0 and episode_index != 0:
                    ...
                    if accuracy > best_accuracy:
                        ...
                        torch.save(model.state_dict(), f"/data/users/soteria/trained_models/fsl_model/{args.dataset}/{save_folder_name}/{args.model}/{args.name}_{args.model}_kshot_{args.k_shot}_pretrained_{args.pretrained_dataset}_iteration_{nb_rep}.pth")
        print("\nTraining Complete\n!")
        ...
        print("Results file: ", 'results_files/{}/{}_{}_{}_test_results.csv'.format(args.dataset, args.model, args.name, args.pretrained_dataset))
        
        if os.path.isfile('results_files/{}/{}_{}_{}_test_results.csv'.format(args.dataset, args.model, args.name, args.pretrained_dataset)):
            f_test = open('results_files/{}/{}_{}_{}_test_results.csv'.format(args.dataset, args.model, args.name, args.pretrained_dataset), 'a')
            writer_test = csv.writer(f_test)
        else:
            f_test = open('results_files/{}/{}_{}_{}_test_results.csv'.format(args.dataset, args.model, args.name, args.pretrained_dataset), 'w')
